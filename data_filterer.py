...
def filter_csv_EIA_dataset(csv_path, type: sheet_type):
    ...
    if type in [sheet_type.DEMAND_RESP, sheet_type.DYNAMIC_PRICING, sheet_type.ENERGY_EFF, sheet_type.NET_METERING,
                sheet_type.OP_DATA, sheet_type.RELIABILITY, sheet_type.SALES_ULT_CUST]:
